...
puts $fp "set_surface_id_vtp [file join $fullrundir mesh-complete mesh-surfaces inflow.vtp] 2"
puts $fp "set_surface_id_vtp [file join $fullrundir mesh-complete mesh-surfaces outlet.vtp] 3"
