...
def mesh_readTGS (filename,resObjName):
  ...
  global guiPDvars
  global guiTGvars
  print(pc.gOptions['meshing_kernel'])
  ...
  for line in fp:
      ...
      if (line.split()[0] == "logon"):
          ...
          print(line.split()[1])
          print "load ok"
          geom.solid_readNative(solid, '/Users/fanweikong/Documents/PythonBindingScripts/tcltest/steady-cylinder-tetgen/cylinder.vtp')
      #set smasherInputName $solid
          if (pc.gOptions['meshing_solid_kernel'] == "PolyData"):
              ...
              if (os.path.isfile(line.split()[1]+'.facenames')):
                  print("sourcing [lrange $line 1 end].facenames")
	  ...
	  print("ok3")
	  print(resObj)
	  print(pyRepository.repos_type(solidPD))
